  ...
  return (
    <main className="min-h-screen relative text-gray-900 dark:text-gray-100">
      ...
      <div className="fixed inset-0 -z-10 h-full w-full bg-white dark:bg-gray-950 overflow-hidden">
        ...
        <div className="absolute top-[15%] left-[5%] text-blue-200 dark:text-blue-900/40 text-8xl font-mono font-bold opacity-20 blur-[3px] -rotate-12">&lt;/&gt;</div>
        <div className="absolute top-[40%] right-[5%] text-cyan-100 dark:text-cyan-900/30 text-9xl font-mono font-bold opacity-30 blur-[5px] rotate-12">&#123; &#125;</div>
        <div className="absolute bottom-[10%] left-[20%] text-indigo-100 dark:text-indigo-900/30 text-[10rem] font-mono font-bold opacity-20 blur-[6px] -rotate-6">[ ]</div>
        <div className="absolute top-[20%] right-[25%] text-purple-200 dark:text-purple-900/50 text-6xl font-mono font-bold opacity-40 blur-[1px] rotate-45">!=</div>
        <div className="absolute bottom-[30%] right-[15%] text-blue-200 dark:text-blue-900/50 text-7xl font-mono font-bold opacity-40 blur-[2px] -rotate-12">=&gt;</div>
        <div className="absolute top-[10%] left-[30%] text-gray-200 dark:text-gray-800 text-5xl font-mono font-bold opacity-50 blur-[1px]">//</div>
        <div className="absolute bottom-[40%] left-[5%] text-emerald-100 dark:text-emerald-900/40 text-6xl font-mono font-bold opacity-40 blur-[2px] rotate-90">&amp;&amp;</div>
        <div className="absolute top-[50%] left-[50%] -translate-x-1/2 text-pink-100 dark:text-pink-900/30 text-4xl font-mono font-bold opacity-60 blur-[1px] animate-pulse">*</div>
        <div className="absolute top-[80%] right-[35%] text-orange-100 dark:text-orange-900/30 text-5xl font-mono font-bold opacity-40 blur-[2px] -rotate-45">$</div>
        <div className="absolute top-[30%] left-[10%] text-sky-100 dark:text-sky-900/40 text-4xl font-mono font-bold opacity-50 blur-[0px]">;</div>
        <div className="absolute bottom-[15%] right-[50%] text-slate-200 dark:text-slate-800 text-3xl font-mono font-bold opacity-50 blur-[1px]">()</div>
        <div className="absolute bottom-0 left-0 w-full opacity-60 dark:opacity-40 pointer-events-none">
          <svg className="w-full h-[300px] md:h-[500px]" viewBox="0 0 1440 320" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            <style>{`
              @keyframes waveMove { 0% { transform: scaleY(1); } 50% { transform: scaleY(1.05); } 100% { transform: scaleY(1); } }
              .wave-path { animation: waveMove 8s ease-in-out infinite; transform-origin: bottom; }
            `}</style>
            <path className="wave-path" fill="none" stroke="url(#gradientWave)" strokeWidth="4" d="M0,160L48,170.7C96,181,192,203,288,197.3C384,192,480,160,576,149.3C672,139,768,149,864,165.3C960,181,1056,203,1152,197.3C1248,192,1344,160,1392,144L1440,128"></path>
            <path className="wave-path" fill="url(#gradientWave)" fillOpacity="0.05" d="M0,160L48,170.7C96,181,192,203,288,197.3C384,192,480,160,576,149.3C672,139,768,149,864,165.3C960,181,1056,203,1152,197.3C1248,192,1344,160,1392,144L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          </svg>
        </div>
      </div>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .animate-scroll-infinite { animation: infinite-scroll 80s linear infinite; }
      `}} />
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-transparent">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="mt-20 pt-10 border-t border-gray-200/50 dark:border-gray-800">
            <p className="text-sm font-semibold text-gray-500 uppercase tracking-widest mb-8">Stack Tecnológico Potente</p>
                ...
                <ul className="flex items-center gap-12 sm:gap-24 animate-scroll-infinite pl-12 sm:pl-24">
                  {techStack.map((tech, index) => (
                    <li key={`original-${index}`} className="flex items-center justify-center">
                      <img src={tech.logo} alt={tech.name} className="h-8 w-auto md:h-10 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300" title={tech.name} />
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <span className="text-blue-600 font-bold tracking-wider uppercase text-sm bg-blue-100/50 px-3 py-1 rounded-full">Nuestros Servicios</span>
            ...
            <div ref={scrollRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-8 -mx-4 px-4 md:mx-0 md:px-0 hide-scrollbar" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              {services.map((srv, index) => (
                <div key={index} className="min-w-[280px] md:min-w-[320px] snap-start bg-white/80 backdrop-blur-md border border-gray-100 p-6 rounded-2xl transition-all duration-300 group flex flex-col items-start cursor-pointer hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(37,99,235,0.2)] hover:border-blue-200">
                  ...
                  <h3 className="text-xl font-bold mb-2 text-gray-900 group-hover:text-blue-600 transition-colors">{srv.title}</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+57 310 793 55 04</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-white shadow-sm border border-gray-100 rounded-lg text-blue-600">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="name" value={formData.name} onChange={handleChange} placeholder="Juan Pérez" required className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="company" className="text-sm font-medium dark:text-gray-300">Empresa</label>
                    <Input id="company" value={formData.company} onChange={handleChange} placeholder="Tu Startup S.A.S" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-medium dark:text-gray-300">Email *</label>
                  <Input id="email" type="email" value={formData.email} onChange={handleChange} placeholder="juan@empresa.com" required className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
                </div>

                <div className="space-y-2">
                  <label htmlFor="service" className="text-sm font-medium dark:text-gray-300">Servicio de interés</label>
                  <select id="service" value={formData.service} onChange={handleChange} className="flex h-10 w-full rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" value={formData.message} onChange={handleChange} required placeholder="Detalles, presupuesto estimado, plazos..." className="min-h-[120px] bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
                </div>

                <Button type="submit" size="lg" disabled={isSubmitting} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 text-lg">
                  {isSubmitting ? (
