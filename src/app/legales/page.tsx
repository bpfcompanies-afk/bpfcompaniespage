...
const legalDocs = [
  {
    ...
    fileUrl: '/docs/TÉRMINOS Y CONDICIONES - BPFCompanies.pdf', // Ruta a tu archivo real
  ...
  },
  {
    ...
    fileUrl: '/docs/ACUERDO GENERAL DE CONFIDENCIALIDAD - BPFCompanies.pdf',
    icon: Shield02Icon,
  ...
  },
  {
    ...
    fileUrl: '/docs/POLÍTICA DE COOKIES - BPFCompanies.pdf',
    icon: Gps01Icon,
  ...
  },
  {
    ...
    fileUrl: '/docs/POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES - BPFCompanies.pdf',
    icon: CopyrightIcon,
    ...
    <div className="min-h-screen bg-gray-50/50 py-20 px-4 md:px-8 font-sans">
      ...
      <div className="max-w-5xl mx-auto mb-16 text-center">
        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
          Centro Legal y <span className="text-transparent bg-clip-text bg-blue-600">Transparencia</span>
        </h1>
