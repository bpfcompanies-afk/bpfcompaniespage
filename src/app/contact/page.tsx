...
export default function ContactPage() {
  ...
  // Datos de FAQ (Conservados de tu código original)
  const faqs = [
    {
  ...
  return (
    <main className="relative min-h-screen text-gray-900 pt-24 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 w-full h-full -z-10 bg-white dark:bg-gray-950 pointer-events-none">
        ...
        {/* 2. Elementos Tipográficos (Notorios) */}
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-20 dark:opacity-10 pointer-events-none">
           {/* <svg className="w-full h-full" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice"> */}
             ...
             <circle cx="400" cy="500" r="10" fill="#6366f1" />
             <path fill="none" stroke="#3b82f6" strokeWidth="2" strokeDasharray="10,10" d="M50,500 L750,50" />
           {/* </svg> */}
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
            ...
            <form className="space-y-6 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="name" placeholder="Juan Pérez" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="company" className="text-sm font-medium dark:text-gray-300">Empresa</label>
                  <Input id="company" placeholder="Tu Startup S.A.S" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
                </div>
              </div>

              <div className="space-y-2">
                <label htmlFor="email" className="text-sm font-medium dark:text-gray-300">Email *</label>
                <Input id="email" type="email" placeholder="juan@empresa.com" className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700" />
              </div>

              <div className="space-y-2">
                <label htmlFor="service" className="text-sm font-medium dark:text-gray-300">Servicio de interés</label>
                <select className="flex h-10 w-full rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600">
              ...
              <Button size="lg" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 text-lg">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6">
            {faqs.map((faq, index) => (
              // Usamos backdrop-blur para que las tarjetas de FAQ se vean bien sobre el fondo fijo
              <div 
                key={index} 
                className="bg-white/70 dark:bg-gray-900/80 backdrop-blur-md p-6 rounded-2xl border border-white/40 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow"
              >
